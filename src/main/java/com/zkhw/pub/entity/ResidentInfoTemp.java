...
public class ResidentInfoTemp {
    ...
    public String getPbArchive() {
        return pbArchive;
    }

    public void setPbArchive(String pbArchive) {
        this.pbArchive = pbArchive == null ? null : pbArchive.trim();
    }
    ...
    public void setHeredityName(String heredityName) {
        this.heredityName = heredityName == null ? null : heredityName.trim();
    }
    ...
    public String getOtherDrink() {
        return otherDrink;
    }

    public void setOtherDrink(String otherDrink) {
        this.otherDrink = otherDrink == null ? null : otherDrink.trim();
    }
    ...
    public void setPoultry(String poultry) {
        this.poultry = poultry == null ? null : poultry.trim();
    }
    ...
    public String getAichiveOrg() {
        return aichiveOrg;
    }

    public void setAichiveOrg(String aichiveOrg) {
        this.aichiveOrg = aichiveOrg == null ? null : aichiveOrg.trim();
    }
    ...
    public void setSynchroResult(String synchroResult) {
        this.synchroResult = synchroResult == null ? null : synchroResult.trim();
    }
