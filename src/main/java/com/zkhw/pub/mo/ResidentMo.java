...
@Getter
@Setter
public class ResidentMo {

	/**
	 * 手术
	 */
	List<OperationRecord> operationRecord;

	/**
	 * 外伤
	 */
	List<TraumatismRecord> traumatismRecord;

	/**
	 * 输血
	 */
	List<MetachysisRecord> metachysisRecord;

	/**
	 * 疾病
	 */
	List<ResidentDiseases> residentDiseases;

	/**
	 * 家族史
	 */
	List<FamilyRecord> familyRecord;
